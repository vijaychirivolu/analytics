    ...
    'identifiers' => [
        ...
        */
        ...
        'ldap' => [
              ...
              //'locate_users_by' => env('LDAP_USER_ATTRIBUTE', 'uid'),

              //'bind_users_by' =>  env('LDAP_USER_ATTRIBUTE', 'userprincipalname'),
              'discover' => env('LDAP_USER_ATTRIBUTE', 'userprincipalname'),
              'authenticate' => env('LDAP_USER_ATTRIBUTE', 'userprincipalname'),
